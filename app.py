...
from routes.game_routes import game_routes  # Importa as rotas do módulo de games

app = Flask(__name__)  # Cria a instância da aplicação Flask

app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///games.db'  # Configura a URI do banco de dados SQLite
...
app.register_blueprint(game_routes)  # Registra o blueprint das rotas de game na aplicação Flask
